package com.transferee.transfer;
...
import com.transferee.loader.ImageLoader;
import com.transferee.loader.UniversalImageLoader;
import com.transferee.style.index.CircleIndexIndicator;
import com.transferee.style.progress.ProgressBarIndicator;
...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    private void fillByRecyclerView(final List<ImageView> originImageList) {
        ...
        for (int i = 0; i < childCount; i++) {
            ImageView originImage = recyclerView.getChildAt(i).findViewById(transConfig.getImageId());
