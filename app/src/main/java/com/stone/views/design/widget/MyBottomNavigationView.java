...
package com.stone.views.design.widget;
...
import com.stone.R;
import com.stone.views.design.internal.BottomNavigationMenu;
import com.stone.views.design.internal.BottomNavigationMenuView;
import com.stone.views.design.internal.BottomNavigationPresenter;
...
public class MyBottomNavigationView extends FrameLayout {
    ...
    public MyBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs,
                R.styleable.MyBottomNavigationView, defStyleAttr,
                R.style.Design_BottomNavigationView);

        if (a.hasValue(R.styleable.MyBottomNavigationView_itemIconTint)) {
            mMenuView.setIconTintList(
                    a.getColorStateList(R.styleable.MyBottomNavigationView_itemIconTint));
        } else {
            mMenuView.setIconTintList(
                    createDefaultColorStateList(android.R.attr.textColorSecondary));
        }
        if (a.hasValue(R.styleable.MyBottomNavigationView_itemTextColor)) {
            mMenuView.setItemTextColor(
                    a.getColorStateList(R.styleable.MyBottomNavigationView_itemTextColor));
        } else {
            mMenuView.setItemTextColor(
                    createDefaultColorStateList(android.R.attr.textColorSecondary));
        }
        if (a.hasValue(R.styleable.MyBottomNavigationView_elevation)) {
            ViewCompat.setElevation(this, a.getDimensionPixelSize(
                    R.styleable.MyBottomNavigationView_elevation, 0));
        }

        int itemBackground = a.getResourceId(R.styleable.MyBottomNavigationView_itemBackground, 0);
        mMenuView.setItemBackgroundRes(itemBackground);

        if (a.hasValue(R.styleable.MyBottomNavigationView_menu)) {
            inflateMenu(a.getResourceId(R.styleable.MyBottomNavigationView_menu, 0));
        }
        a.recycle();
