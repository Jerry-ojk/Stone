...
public abstract class StoneFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageView = parent.findViewById(R.id.photo_view);
        ...
        ImageManager.loadBigImage(stone, imageView);
        imageView.setOnClickListener(v -> stoneActivity.showImage(ImageManager.getBitmapFromImageView(imageView)));
